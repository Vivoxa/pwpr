...
ActiveRecord::Schema.define(version: 20161004193113) do
  ...
  add_index "schemes", ["email"], name: "index_schemes_on_email", unique: true, using: :btree
  add_index "schemes", ["reset_password_token"], name: "index_schemes_on_reset_password_token", unique: true, using: :btree
