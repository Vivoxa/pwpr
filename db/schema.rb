...
ActiveRecord::Schema.define(version: 20161004070410) do
  ...
  create_table "scheme_owners", force: :cascade do |t|
  ...
  add_index "scheme_owners", ["email"], name: "index_scheme_owners_on_email", unique: true, using: :btree
  add_index "scheme_owners", ["reset_password_token"], name: "index_scheme_owners_on_reset_password_token", unique: true, using: :btree
