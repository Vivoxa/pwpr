...
#************************************************************************************
  ...
  email_content.intro = 'Dear Sir'
  email_content.title = 'Registrtion form 2017'
  email_content.body = 'We would like to inform you of a change to our registration process for the <year> packaging compliance year.
  The attached Registration Details Form includes the information that we currently hold for your company. We will use this information to register you with the Environment Agency. Could you please check these details carefully, amend where necessary and return a signed copy of this form to <scheme_name> by 28th February <year>. Please return a signed copy, even if there are no changes.
