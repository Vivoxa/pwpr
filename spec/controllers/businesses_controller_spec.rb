...
RSpec.describe BusinessesController, type: :controller do
  ...
  let(:valid_attributes) do
    {NPWD: 'kgkgk', SIC: 'khgifk', name: 'business 1', membership_id: 'mem-1', company_no: '123456789'}
  end

  let(:invalid_attributes) do
    {NPWD: nil, SIC: nil, name: 'business 1', membership_id: 'mem-1', company_no: '123456789'}
  end
