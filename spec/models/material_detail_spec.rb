...
RSpec.describe MaterialDetail, type: :model do
  ...
  context 'Validations' do
    describe '#validates_presence_of' do
      ...
      it { is_expected.to validate_presence_of(:t1manwo) }
